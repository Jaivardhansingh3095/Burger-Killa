...
function Checkout() {
  ...
  if (!cart.length) {
    return (
      <div className="flex items-center justify-center w-full h-screen font-semibold">
        <div className="flex flex-col items-center justify-center w-full h-full gap-5 px-10">
  ...
  return (
    <div className="w-full bg-gray-50 lg:min-h-screen">
      <div className="mx-auto max-w-[1250px] h-full flex flex-col lg:flex-row gap-10 lg:gap-0 px-2 sm:px-10 py-2 lg:px-4 xl:px-0 lg:py-5 overscroll-y-auto">
        <div className="w-full lg:w-[65%] h-full px-1 sm:px-2 flex flex-col gap-10 lg:gap-4">
          <SelectAddress
            user={user}
            address={address}
        ...
        <div className="w-full lg:w-[35%] lg:sticky lg:top-5 h-full px-1 sm:px-2 flex flex-col justify-start gap-10 lg:gap-4">
          <Offer />
